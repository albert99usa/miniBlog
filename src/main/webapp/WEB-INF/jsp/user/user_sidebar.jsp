...
<div class="list-group">
    ...
    <a href="${contextPath}/user/info/${loginUser.username}" class='list-group-item heading <c:if test="${'userinfo'==param.activeTab}">active</c:if>'>個人資料</a>
    <a href="${contextPath}/user/changePwd" class='list-group-item <c:if test="${'changepwd'==param.activeTab}">active</c:if>'>修改密码</a>
    <a href="${contextPath}/user/changeAvatar" class='list-group-item <c:if test="${'changeavatar'==param.activeTab}">active</c:if>'>修改頭像</a>
